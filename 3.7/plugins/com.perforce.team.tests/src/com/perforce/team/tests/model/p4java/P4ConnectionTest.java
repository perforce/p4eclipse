...
public class P4ConnectionTest extends ConnectionBasedTestCase {
    ...
    public void tearDown() throws Exception, AccessException{
    	super.tearDown();
        FileUtils.forceDelete(new File(localclient.getRoot()));
    ...
    public void testIntegrate() {
        ...
        IP4Resource[] resources = connection.integratePreview(options, "", 0, "", false, P4TeamUtils.createDefaultIntegration(connection), false);
