...
public interface IP4Connection extends IP4Container {
     ...
     * @return - array of p4 changelists
     */
    IP4PendingChangelist[] getPendingChangelists(boolean all, int maxFetchCount);
...
//     */
//    IP4Resource[] integrateFiles(P4FileIntegration integration, int changelist,
//            boolean preview, boolean all, P4IntegrationOptions options, boolean isAddPreviouslyLinkedJobs);
    ...
    IP4Resource[] integrate(P4FileIntegration integration, String branch,
            int changelist, String description, boolean all,
            P4IntegrationOptions options, boolean isAddPreviouslyLinkedJobs);
    
    IP4Resource[] integratePreview(final P4FileIntegration integration, String branch, int changelist, final String description, final boolean all,
    ...
    /**
     * Do a P4 print on a spec path into a temp file
     * 
     * @param specPath
    ...
    /**
     * Update a P4 client on the server
     * 
     * @param newClient
