...
public class P4ResourceNode extends ResourceNode implements IP4CompareNode {
    ...
    public boolean equals(Object obj) {
    	...
    	return P4CoreUtils.equals(label, other.getLabel())
    			&& P4CoreUtils.equals(getResource().getFullPath(), other.getResource().getFullPath());
    }
    
    @Override
    public int hashCode() {
    	// override to prevent coverity from complaining: FB.EQ_COMPARETO_USE_OBJECT_EQUALS
    	return label==null?super.hashCode():super.hashCode()+label.hashCode()*31 + getResource().getFullPath().hashCode();
    }
