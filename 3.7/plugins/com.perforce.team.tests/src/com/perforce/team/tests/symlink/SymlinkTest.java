...
//    	RpcPerforceFileType type = RpcPerforceFileType.inferFileType(filelink, 1024, false, Charset.forName("UTF8"));
//    	assertTrue(type==RpcPerforceFileType.FST_SYMLINK);
//
//    	type = RpcPerforceFileType.inferFileType(folderlink, 1024, false, Charset.forName("UTF8"));
////    	try {
