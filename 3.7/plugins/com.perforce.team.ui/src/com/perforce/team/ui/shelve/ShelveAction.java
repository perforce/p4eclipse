...
public class ShelveAction extends AsyncEnablementAction {
    ...
    private void shelveNew(final IP4PendingChangelist list,
            ...
            final boolean revert, final boolean wipe) {
        IP4Runnable runnable = new P4Runnable() {
            ...
            public void run(IProgressMonitor monitor) {
        		...
        		if (revert) {
        			P4Collection revertSelection = createCollection(files);
        			revertSelection.revert(wipe);
        			monitor.worked(1);
        			
        			revertSelection.refreshLocalResources(IResource.DEPTH_INFINITE);
            ...
            public void run() {
                ...
                if (ConfirmShelveDialog.OK == dialog.open()) {
                    ...
                    if (selection.length > 0) {
                        ...
                        shelveNew(list, selection, true, description, revert, wipe);
                    }
                }
            }
        });
