...
public class PerforceSubscriberTest extends ProjectBasedTestCase {
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            addFile(client, project.getFile(".cproject"),
                    new ByteArrayInputStream("test".getBytes()));
            addFileWithContent(client, project.getFile("ResolveTestFile.cproject"), "version: " + i);
        }
    ...
    /**
     * Test the members method on the P4 subscriber
     */
    ...
    public void testOutgoingResolve() {
        checkProject();
        IFile resolveFile = project.getFile("ResolveTestFile.cproject");
