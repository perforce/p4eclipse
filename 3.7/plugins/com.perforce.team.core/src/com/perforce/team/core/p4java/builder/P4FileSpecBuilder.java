...
public class P4FileSpecBuilder {
	...
	/**
	 * Given an array of file paths (which might include revision or label
	 * specs, etc.), return a corresponding list of file specs. Returns null if
	 * pathArray is null; skips any null element of the array.
	 * 
	 * @param pathArray
	...
	public static List<IFileSpec> makeFileSpecList(final String[] pathArray) {
	...
	/**
	 * Given a list of file specs, return a list of the valid file specs in that
	 * list. "Valid" here means a) non-null, and b) getOpStatus() returns VALID.
	 * 
	 * @param fileSpecs
	...
	/**
	 * Given a list of file specs, return a list of the invalid file specs in
	 * that list. "Invalid" here means a) non-null, and b) getOpStatus() returns
	 * anything but VALID.
	 * 
	 * @param fileSpecs
	 *            candidate file specs
