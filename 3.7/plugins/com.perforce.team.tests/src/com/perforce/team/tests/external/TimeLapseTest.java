...
public class TimeLapseTest extends ProjectBasedTestCase {
    ...
    protected void initParameters() {
        ...
        assertNotNull(System.getProperty("p4vc"));
        p4vc = System.getProperty("p4vc");
    }
    ...
    public void setUp() throws Exception {
        ...
        PerforceUIPlugin.getPlugin().getPreferenceStore()
                .setValue(IPreferenceConstants.P4VC_PATH, p4vc);
    }

    /**
     * Test p4vc time lapse view
     */
