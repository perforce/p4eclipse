...
public class PendingViewControl extends AbstractPerforceViewControl implements IP4Listener, IPropertyChangeListener{
        ...
        if (connectionOK(connection)) {
            ...
            P4Runner.schedule(new P4Runnable() {
                ...
                public void run(IProgressMonitor monitor) {
                    ...
                    final IP4PendingChangelist[] lists =connection.getPendingChangelists(showOtherChanges, getFetchCount()); 
                    ...
                    swarmReviewManager.createCache(lists);
