...
//		}
		...
		if(isStreamDifferent(oldSpec.getStream(), newSpec.getStream()) ){
			if(newSpec.getClientView() != null && newSpec.getClientView().getEntryList().isEmpty() 
					&& StringUtils.isEmpty(newSpec.getStream())){
	    		return false;
	    	}
			return true;
		}
		...
		if(StringUtils.isEmpty(newSpec.getStream()) && 
				(newSpec.getClientView().getEntryList() != null && newSpec.getClientView().getEntryList().isEmpty())){
			return false;
		}
