...
public class IntegrateActionTest extends ProjectBasedTestCase {
    ...
    public void testAction() {
        ...
        try {
            ...
            integrate.integrate(source, target, null, null, 0, P4IntegrationOptions.createInstance(p4File.getServer()), false);
    ...
    public void testIntegratedOver() {
        ...
        try {
            ...
            integrate.integrate(source, target, null, null, 0, options, false);
