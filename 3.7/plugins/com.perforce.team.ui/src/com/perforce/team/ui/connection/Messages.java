...
public class Messages extends NLS {
    ...
    public static String ServerWizardPage_ErrorAuthenticatingUserTitle;
    public static String ServerWizardPage_ErrorAuthenticatingUserMessage;
    ...
    public static String ServerWizardPage_IgnoreSSLValidation;
