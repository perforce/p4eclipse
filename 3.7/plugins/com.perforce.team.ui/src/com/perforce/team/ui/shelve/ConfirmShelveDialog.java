...
public class ConfirmShelveDialog extends P4StatusDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        revertButton = new Button(composite, SWT.CHECK);
        revertButton.setText(Messages.ConfirmShelveDialog_RevertCheckedOutFiles);
        removeButton = new Button(composite, SWT.CHECK);
    ...
    private void validate() {
        ...
        if (errorMessage != null) {
            ...
            setInfoMessage(
                    Messages.ConfirmShelveDialog_SelectedFilesWillBeReopenedBeforeShelving);
        }
    }
