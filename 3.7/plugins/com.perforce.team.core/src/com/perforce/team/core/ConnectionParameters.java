...
/**
 * Holds the connection parameters for a P4 connection
 */
public class ConnectionParameters {
    ...
    public static final String IGNORE_SSL = "IGNORE_SSL"; //$NON-NLS-1$
    ...
    public ConnectionParameters(String connectString) {
        ...
        while (tokens.hasMoreTokens()) {
            ...
            if (P4PORT.equals(key)) {
                ...
                setPassword(value);
            } else if (IGNORE_SSL.equals(key)) {
                setIgnoreSSLValidation(Boolean.parseBoolean(value));
    ...
    public String toString() {
        ...
        // }
        s.append(IGNORE_SSL + " " +  Boolean.toString(ignoreSSLValidation) + " ");
