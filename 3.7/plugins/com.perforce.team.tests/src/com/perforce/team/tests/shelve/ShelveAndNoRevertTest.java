...
public class ShelveAndNoRevertTest extends ProjectBasedTestCase {
     ...
     */
    @Test
    public void testShelveAndNoRevert() {
        ...
        try {
            ...
            //##### CHECKING FILES WERE NOT REVERTED ON DISK ######
            ...
            assertTrue(localFileToAdd.exists());
            assertTrue(localFileRenamed.exists());
            assertFalse(localFileToRename.exists());
