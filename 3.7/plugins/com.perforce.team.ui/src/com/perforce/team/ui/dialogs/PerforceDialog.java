...
public class PerforceDialog extends Dialog {
	...
	protected Combo createCombo(Composite parent, String[] items, boolean readonly) {
	...
	protected List createList(Composite parent, int vspan, int height, int width, boolean multi) {
