 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ AddActionTest.class
//	, RemoveActionTest.class,
//    RemoveServerActionTest.class, ResolveTest.class,
//	    AddIgnoreActionTest.class,
...
//        EditAdaptedActionTest.class, 
//        EditChangelistActionTest.class,
