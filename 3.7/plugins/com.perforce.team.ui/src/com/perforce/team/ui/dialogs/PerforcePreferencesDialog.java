...
/**
 * Superclasses for P4 perforce pages
 */
public abstract class PerforcePreferencesDialog extends PreferencePage
    ...
    /**
     * P4 colour editor. Supports multiple columns and getting the help
     * control.
     */
    ...
    /**
     * P4 boolean editor. Supports multiple columns and getting the help
     * control.
     */
    ...
    /**
     * P4 string editor. Supports multiple columns and getting the help
     * control.
     */
    ...
    /**
     * P4 font editor. Supports multiple columns and getting the help
     * control.
     */
    ...
    protected PerforceColorFieldEditor createColorFieldEditor(
        ...
        editor.setPage(this);
        editor.setPreferenceStore(getPrefStore());
        return editor;
    }
    ...
    private IPreferenceStore getPrefStore(){
    	...
    	if(store == null){
    		store = new ScopedPreferenceStore(InstanceScope.INSTANCE, PerforceUIPlugin.getPlugin().getBundle().getSymbolicName());
    	}
    	return store;
    }
    ...
    protected void setPrefInt(String key, int value) {
    	getPrefStore().setValue(key, value);
    }
    ...
    protected int getPrefInt(String key) {
        return getPrefStore().getInt(key);
    }
    ...
    protected int getPrefDefInt(String key) {
        return getPrefStore().getDefaultInt(key);
    }
    ...
    protected boolean getPrefBoolean(String key) {
        return getPrefStore().getBoolean(key);
    }
    ...
    protected boolean getPrefDefBoolean(String key) {
        return getPrefStore().getDefaultBoolean(key);
    }
    ...
    protected String getPrefString(String key) {
        return getPrefStore().getString(key);
    }
    ...
    protected String getPrefDefString(String key) {
        return getPrefStore().getDefaultString(key);
    }
}
