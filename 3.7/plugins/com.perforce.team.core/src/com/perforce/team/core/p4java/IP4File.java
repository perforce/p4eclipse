...
/**
 * Base interface for a file in a P4 repository
 * 
...
public interface IP4File extends IEventObject, IContentEmitter, IP4Resource {
    ...
    /**
     * Gets the revision number of the file current in the P4 client
     * workspace
     * 
     * @return - int revision number
     */
    ...
    /**
     * Get the local filesystem file representing this P4 file. May return
     * or a non-existent file handle.
     * 
     * @return - file, may be null if this P4 file does not have a local
     *         path
     */
    File toFile();
